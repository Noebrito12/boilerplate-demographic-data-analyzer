...
def calculate_demographic_data(print_data=True):
    ...
    non_percentage_higer = len(higher_education[higher_education.salary == ">50k"])
    higher_education_rich = round(non_percentage_higer / len(higher_education) * 100,1)
    ...
    people_of_indian = df[(df['native-country'] == "India") & (df["salary"] == ">50k")]
    occupation_counts = people_of_indian['occupation'].value_counts()
